        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Phiếu chi</span>
                </div>
                ...
                <div class="pull-right m-r">
                    <select class="form-control" id="bill_type">
                        ...
                        <option value="1">Chi nội</option>
                        <option value="2">Chi ngoại</option>
                    </select>
                </div>

                <a class="btn btn-success pull-right admin-btn m-r" onclick="load_bill_outcome_add()" href="#bill_outcome_detail" data-toggle="modal"><i class="fa fa-plus"></i> thêm</a>
                <a class="btn btn-danger pull-right admin-btn" href="javascript:void(0)" onclick="delete_bill_outcome_multiple();"><i class="fa fa-times"></i> xoá</a>
            </div>
            <div class="portlet-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="table-container table-responsive">
                            <table class="table table-hover" id="bill_outcome_list">
                                <thead>
...
<div id="bill_outcome_detail" class="modal fade">
    <div class="modal-dialog" style="width: 50%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h3 class="modal-title"><i class="fa fa-edit"></i> Phiếu chi</h3>
            </div>
            <form id="bill_outcome_form">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="form-group m-t-sm">
                    ...
                    <div class="col-md-9">
                        <select class="form-control" name="type" id="type">
                            ...
                            <option value="1" >Chi công nợ</option>
                    
                            <option value="2" >Chi khác</option>
                    
                            <option value="3" >Chi tiền xuất trả hàng cho KH</option>
                    
                            <option value="4" >Chi tiền đặt cọc</option>
                    
                            <option value="5" >Chi lại tiền đặt cọc</option>
                    
                            <option value="6" >Chi chuyển tiền nội bộ</option>
            ...
            <div class="modal-footer">
                <a class="btn btn-info" onclick="bill_outcome_list_filter();"><i class="fa fa-search"></i> tìm</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
