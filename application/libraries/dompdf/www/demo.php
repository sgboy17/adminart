...
<textarea name="html" cols="60" rows="20">
  ...
  <head>
  <style type="text/css">
  .l-1-1 img{ width:960px; height:600px; }
  .r-1-1 img{ width:960px; height:600px; margin-left: -480px; }
  .c-1-2 img{ width:480px; height:600px; }
  .t-1-4, .t-1-4 img{ width:480px; height:300px; }
  .b-1-4 img{ width:480px; height:300px; }
  ...
  <div class="c-1-2">
    <img src="img/bootstrap-mdo-sfmoma-00.jpg" />
   </div>
   <div class="l-1-1 page">
