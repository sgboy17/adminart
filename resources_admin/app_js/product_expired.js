if($('#product_expired_list').length){
	var product_expired_list = $('#product_expired_list').dataTable({
		    "bProcessing": true,
		    "bServerSide": true,
		    "sPaginationType": "full_numbers",
		    "sAjaxSource": base_url+"productexpired/get_product_expired_list",
		    "bDeferRender": true,
		    "bLengthChange": false,
		    "bFilter": false,
		    "bDestroy": true,
     ...
     $("#range_date").on("change", function () {
        product_expired_list.fnDraw(); 
    });
                
        
}

function delete_product_expired_multiple(){
    if(confirm('Bạn có chắc muốn xoá những dữ liệu này?')){
        ...
        jQuery.ajax({
            type: 'POST',
            url: base_url+'productexpired/delete_product_expired',
            data: {
                id: id
            },
...
function delete_product_expired(id){
