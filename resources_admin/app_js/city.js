if($('#city_list').length){
	var city_list = $('#city_list').dataTable({
		    ...
		    "sAjaxSource": base_url+"city/get_city_list",
		    "bDeferRender": true,
		    "bLengthChange": false,
		    "bFilter": false,
		    "bDestroy": true,
...
function load_city_add(){
    jQuery.ajax({
        type: 'POST',
        url: base_url+'city/load_city_add',
        beforeSend: function(xhr) {
            jQuery("#city_detail #city_form").html('<div align="center" style="margin: 10px;"><img src="'+base_url+'resources_admin/images/loaders/circular/072.gif" /></div>');      
        },
        error:function(){
        ...
        success:function(resp){
            jQuery("#city_detail #city_form").html(resp);
            validate_city_form();
        }
    });  
}

function load_city_edit(id){
    jQuery.ajax({
        type: 'POST',
        url: base_url+'city/load_city_edit',
        data: {
            id: id,
        },
        beforeSend: function(xhr) {
...
function save_city_add(element){
    if($("#city_form").valid()){
         jQuery.ajax({
           type:'POST',
           url:base_url+'city/save_city_add',
...
function save_city_edit(element){
    if($("#city_form").valid()){
         jQuery.ajax({
           type:'POST',
           url:base_url+'city/save_city_edit',
           data:$('#city_form').serialize(),
           beforeSend: function(xhr) {
                $.blockUI({css: {
                    border: 'none',
